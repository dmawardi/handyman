...
keywords="handyman services, plumbing, electrical work, carpentry, maintenance, Bali" canonical="url('/services')">
    ...
    <x-services.service-grid />
    <x-hero-section title="Need Help Now?" description="Request a handyman today and get your issue fixed quickly and professionally." buttonText="Request a Job" />
</x-app-layout>