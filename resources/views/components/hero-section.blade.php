...
<div class="bg-gradient-to-r from-blue-600 to-blue-800 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        <div class="text-center max-w-3xl mx-auto">
            ...
            @if($buttonText!=="")
                <div class="mt-8">
                    <a href="{{ $buttonAction }}" class="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-blue-700 bg-white hover:bg-gray-100 hover:text-blue-800 transition ease-in-out duration-150 shadow-md">
