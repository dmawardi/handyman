...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\JobRequestAttachment>
 */
class JobRequestAttachmentFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        return [
            ...
            'type' => $this->faker->randomElement(['user_upload', 'admin_upload', 'internal', 'before', 'after']),
